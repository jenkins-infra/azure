...
locals {
  ...
  shared_galleries = {
    "dev" = {
      ...
      images      = ["ubuntu-22.04-amd64", "ubuntu-22.04-arm64", "windows-2022-amd64", "windows-2025-amd64"]
    }
    "staging" = {
  ...
  app_subnets = {
    ...
    "cert.ci.jenkins.io" = {
      "controller" = [data.azurerm_subnet.cert_ci_jenkins_io_sponsored_controller.id],
      "agents" = [
        # VM agents (Jenkins Sponsored subscription)
