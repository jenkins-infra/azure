  ...
  content = jsonencode({
    "cert.ci.jenkins.io" = {
      "agents_azure_vms" = {
        ...
        "user_assigned_identity_client_id" = azurerm_user_assigned_identity.cert_ci_jenkins_io_jenkins_agents.client_id,
      },
      "agents_azure_vms_jenkins_sponsored" = {
        ...
        "user_assigned_identity_client_id" = azurerm_user_assigned_identity.cert_ci_jenkins_io_azurevm_agents_jenkins_sponsored.client_id,
      },
    },
    "infra.ci.jenkins.io" = {
