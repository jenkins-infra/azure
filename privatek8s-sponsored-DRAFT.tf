resource "azurerm_resource_group" "privatek8s_sponsorship" {
  ...
  name     = "prod-privatek8s-sponsorship"
...
resource "azurerm_kubernetes_cluster" "privatek8s_sponsorship" {
  ...
  kubernetes_version                = local.kubernetes_versions["privatek8s_sponsorship"]
  dns_prefix                        = "privatek8s-sponsorship"
      ...
      formatlist(
        ...
        flatten(
          concat(
            ...
            # privatek8s_sponsorship outbound IPs (traffic routed through gateways or outbound LBs)
  ...
  default_node_pool {
    ...
    orchestrator_version = local.kubernetes_versions["privatek8s-sponsorship"]
...
resource "azurerm_kubernetes_cluster_node_pool" "infraciarm64_sponsorship" {
  name                  = "arm64smallSp"
