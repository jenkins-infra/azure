...
# Important: the Enterprise Application "terraform-production" needs to be able to manage this subnet
# See the corresponding role assignemnt defined here (private repo): https://github.com/jenkins-infra/terraform-states/blob/897b8a3764623764dd0e2a14e78b2347bd4ece01/azure/main.tf#L49
