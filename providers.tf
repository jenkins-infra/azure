...
provider "kubernetes" {
  ...
  client_key             = base64decode(azurerm_kubernetes_cluster.infracijenkinsio_agents_2.kube_config.0.client_key)
  cluster_ca_certificate = base64decode(azurerm_kubernetes_cluster.infracijenkinsio_agents_2.kube_config.0.cluster_ca_certificate)
}
